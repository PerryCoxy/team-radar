      ...
      <CardContent className="space-y-4">
        ...
        <div className="grid grid-cols-3 gap-4">
          ...
          <div className="text-center">
            ...
            <div className="text-lg font-semibold text-foreground">{formatSize(developer.totalSize)}</div>
          </div>

          <div className="text-center">
            <div className="text-sm text-muted-foreground">Время</div>
            <div className="text-lg font-semibold text-foreground">{formatTime(developer.totalTimeTracking)}</div>
          </div>
        </div>
